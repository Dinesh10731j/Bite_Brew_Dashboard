      ...
      <section className="relative w-full max-w-[1100px] grid lg:grid-cols-2 bg-white/80 backdrop-blur-xl rounded-[2.5rem] overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-white">
        ...
        <div className="hidden lg:flex flex-col justify-between p-16 bg-[#0a2920] text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-6">
             <div className="flex -space-x-4">
               {[1, 2, 3, 4].map((i) => (
                 <div key={i} className="w-10 h-10 rounded-full border-4 border-[#0a2920] bg-[#207659] flex items-center justify-center text-[10px] font-bold overflow-hidden">
        ...
        <div className="p-8 md:p-20 flex flex-col justify-center bg-white">
          <div className="mb-12">
            ...
            <h1 className="text-5xl font-black text-[#0a2920] lowercase italic tracking-tighter">
              welcome back
            </h1>
...
<form className="space-y-5" method="post" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="group space-y-2">
              ...
              <div className="relative">
                <Mail className="absolute left-5 top-1/2 -translate-y-1/2 text-black/20 group-focus-within:text-[#207659] transition-colors" size={20} />
                <input
                  {...register("email", { 
            ...
            <div className="group space-y-2">
              ...
              <div className="relative">
                <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-black/20 group-focus-within:text-[#207659] transition-colors" size={20} />
                <input
                  {...register("password", { 
          ...
          <div className="mt-12 pt-8 border-t border-black/[0.03] flex flex-col sm:flex-row gap-6 justify-between items-center">
            <Link href="/signup" className="group text-[10px] font-black uppercase tracking-widest text-black/30 hover:text-[#0a2920] transition-colors flex items-center gap-2">
              <span className="w-1 h-1 rounded-full bg-black/10 group-hover:bg-[#8EC894] transition-colors" />
              New Member?
            </Link>
            <Link href="/forgot-password"  className="text-[10px] font-black uppercase tracking-widest text-black/30 hover:text-[#0a2920] transition-colors">
              Recover Access
            </Link>
          </div>
        </div>
